...
![alt text](capturas/print5.png)
5. Podemos adicionar mais eventos conforme fizemos anteriormente e digitar "5" no menu principal para ver as métricas da arvore:
![alt text](capturas/print6.png)
6. No menu principal, digitamos "0" para fechar o sistema:
![alt text](capturas/print7.png)
